  ...
  render() {
    return (
        ...
        <div className={classes.ideaSelfMadePostersForTheMembe}>idea: self made posters for the members of the group</div>
            ...
            <p className={classes.textBlock}>Lorem ipsum dolor sit amet consectetur. Penatibus gravida urna mauris a. Ut vestibulum at sed habitant massa id feugiat lacus. Tellus duis ac nec nulla vestibulum nulla. Amet mauris pharetra praesent quis vehicula dignissim leo.
